...
import 'package:inr_d/Views/YourOwnSGDAccount.dart';

class YourOwnNZDAccount extends StatelessWidget {
  const YourOwnNZDAccount({Key? key}) : super(key: key);
