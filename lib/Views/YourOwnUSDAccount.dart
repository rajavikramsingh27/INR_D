...
import 'package:inr_d/Views/YourOwnEuroAccount.dart';

class YourOwnUSDAccount extends StatelessWidget {
  const YourOwnUSDAccount({Key? key}) : super(key: key);
