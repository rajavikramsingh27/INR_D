...
import 'package:inr_d/Views/YourOwnGBPAccount.dart';
import 'package:inr_d/Views/YourOwnUSDAccount.dart';

class YourOwnCADAccount extends StatelessWidget {
  const YourOwnCADAccount({Key? key}) : super(key: key);
