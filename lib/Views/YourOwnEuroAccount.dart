...
import 'package:inr_d/Views/YourOwnNZDAccount.dart';

class YourOwnEuroAccount extends StatelessWidget {
  const YourOwnEuroAccount({Key? key}) : super(key: key);
