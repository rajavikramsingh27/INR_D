...
import 'package:inr_d/Views/YourOwnINRAccount.dart';

class YourOwnAUDAccount extends StatelessWidget {
  const YourOwnAUDAccount({Key? key}) : super(key: key);
